            ...
            >
                ...
                {/* <Tooltip content="Add Relevance" position="right">
                    <Button
                        ...
                        icon="plus"
                        onClick={() => {
                            addAiNodes([{ flowDataState, sourceId: id, isNewNodePro: true, targetNodePolarity: data.pol, affects: 'relevance' }])
                ...
                <Tooltip content="Add Relevance" position="right">
                    <Button
                        ...
                        icon="plus"
                        onClick={() => {
                            addAiNodes([{ flowDataState, sourceId: id, isNewNodePro: false, targetNodePolarity: data.pol, affects: 'relevance' }]);
                            reactFlowInstance.fitView({ padding: 0.5, duration: 1000 });
                        }}
                    />
                </Tooltip> */}
                <Tooltip content="Add Pros/Cons" position="right">
                    <Button
                        minimal
                        small
                        className="mb-1 !bg-pro"
                        ...
                        onClick={() => {
                            handleSubmit({
                                sourceId: id,
                                claim: data.claim.content
                            })
                            reactFlowInstance.fitView(DEFAULT_FIT_VIEW);
                        }}
                    />
                </Tooltip>
