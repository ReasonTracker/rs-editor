...
export function NodeDisplay(props: NodeProps<DisplayNodeData>) {
  ...
  const relevance = (
    <div className="rsCalc" style={{ gridArea: "relevance", width: "50px" }}>
      <svg height={data.score.relevance * maxStrokeWidth} width={"50px"}>
        <polygon
          style={{ opacity: 0.4, fill: `var(--${data.pol})` }}
          points={`
                        0                 , 0
                        0                 , ${
                          data.score.relevance * maxStrokeWidth
                        }
                        50 , ${maxStrokeWidth}
                        50 , 0
                    `}
        ...
        <polygon
          ...
          points={`
                        0                 , ${
                          data.score.relevance * halfStroke -
                          data.score.confidence * maxStrokeWidth
                        }
                        0                 , ${
                          data.score.relevance * halfStroke +
                          data.score.confidence * maxStrokeWidth
  ...
  const cancelOut = (
    <div
      className="rsCalc"
      style={{ gridArea: "cancelOut", position: "relative" }}
    >
      <div
        style={{
          opacity: 0.4,
          backgroundColor: `var(--${data.pol})`,
          height: `${maxStrokeWidth}px`,
        }}
      ></div>
      <div
        style={{
        ...
        <>
          ...
          >
            ...
            <polygon
              ...
              points={`
                                    0                 , ${
                                      data.cancelOutStacked.top * maxStrokeWidth
                                    }
                                    0                 , ${
                                      data.cancelOutStacked.bottom *
                                      maxStrokeWidth
                                    }
                                    ${maxStrokeWidth * 2} , ${
                data.cancelOutStacked.bottom * maxStrokeWidth
              }
                                    ${maxStrokeWidth * 2} , ${
                data.cancelOutStacked.top * maxStrokeWidth
              }
                ...
                return (
                  <Fragment key={s.id}>
                    <polygon
                      ...
                      points={`
                        0                 , ${
                          scaledTo1Stacked.top * maxStrokeWidth
                        }
                        0                 , ${
                          scaledTo1Stacked.bottom * maxStrokeWidth
                        }
                  ...
                  <Fragment key={s.id}>
                    <path
                      style={{
                        ...
                        strokeWidth:
                          (reducedImpactStacked.bottom -
                            reducedImpactStacked.top) *
                          maxStrokeWidth,
                      }}
                      d={edgePath}
                    />
            ...
            {allSources.map((s) => {
              ...
              if (data) {
                ...
                return (
                  <Fragment key={s.id}>
                    <polygon
                      style={{ opacity: 0.4, fill: `var(--${s.data?.pol})` }}
                      points={`
                                    0                 , ${
                                      reducedMaxImpactStacked.top *
                                      maxStrokeWidth
                                    }
                                    0                 , ${
                                      reducedMaxImpactStacked.bottom *
                                      maxStrokeWidth
                                    }
                                    ${maxStrokeWidth} , ${
                        maxImpactStacked.bottom * maxStrokeWidth
                      }
                                    ${maxStrokeWidth} , ${
                        maxImpactStacked.top * maxStrokeWidth
                      }
                                `}
                    />
                    ...
                    <polygon
                      ...
                      points={`
                                    0                 , ${
                                      reducedImpactStacked.top * maxStrokeWidth
                                    }
                                    0                 , ${
                                      reducedImpactStacked.bottom *
                                      maxStrokeWidth
                                    ...
                                    ${maxStrokeWidth} , ${
                        impactStacked.bottom * maxStrokeWidth
                      }
                                    ${maxStrokeWidth} , ${
                        impactStacked.top * maxStrokeWidth
                      }
                                `}
                    />
                  </Fragment>
  ...
  return (
    <div className="rsNode">
      <div
        className="rsNodeGrid"
        style={{ minHeight: (allSources?.length || 1) * maxStrokeWidth }}
      >
        {relevance}
        {cancelOut}
        {scaleTo1}
